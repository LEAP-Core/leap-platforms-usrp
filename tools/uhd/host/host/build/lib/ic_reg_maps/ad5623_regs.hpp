/***********************************************************************
 * This file was generated by /home/kfleming/uhd/host/lib/ic_reg_maps/gen_ad5623_regs.py on Sat Apr  2 14:36:28 2011
 **********************************************************************/
...
public:
    ...
    boost::uint32_t get_reg(void){
        ...
        reg |= (boost::uint32_t(data) & 0xfff) << 4;
        reg |= (boost::uint32_t(addr) & 0x7) << 16;
        reg |= (boost::uint32_t(cmd) & 0x7) << 19;
        return reg;
    }
