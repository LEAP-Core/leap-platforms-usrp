/***********************************************************************
 * This file was generated by /home/kfleming/uhd/host/lib/ic_reg_maps/gen_max2112_regs.py on Sat Apr  2 14:36:28 2011
 **********************************************************************/
...
public:
    ...
    frac_t frac;
    boost::uint8_t n_divider_msb;
    boost::uint8_t n_divider_lsb;
    boost::uint8_t cpmp;
    boost::uint8_t cplin;
    boost::uint8_t f_divider_mmsb;
    boost::uint8_t f_divider_msb;
    boost::uint8_t f_divider_lsb;
    enum xtal_divider_t{
        XTAL_DIVIDER_DIV1 = 0,
        XTAL_DIVIDER_DIV2 = 1,
        XTAL_DIVIDER_DIV3 = 2,
    ...
    boost::uint8_t get_reg(boost::uint8_t addr){
        ...
        switch(addr){
        case 0:
            reg |= (boost::uint8_t(frac) & 0x1) << 7;
            reg |= (boost::uint8_t(n_divider_msb) & 0x7f) << 0;
            break;
        case 1:
            reg |= (boost::uint8_t(n_divider_lsb) & 0xff) << 0;
            break;
        case 2:
            reg |= (boost::uint8_t(cpmp) & 0x3) << 6;
            reg |= (boost::uint8_t(cplin) & 0x3) << 4;
            reg |= (boost::uint8_t(f_divider_mmsb) & 0xf) << 0;
            break;
        case 3:
            reg |= (boost::uint8_t(f_divider_msb) & 0xff) << 0;
            break;
        case 4:
            reg |= (boost::uint8_t(f_divider_lsb) & 0xff) << 0;
            break;
        case 5:
            reg |= (boost::uint8_t(xtal_divider) & 0x7) << 5;
            reg |= (boost::uint8_t(r_divider) & 0x1f) << 0;
            break;
        case 6:
            reg |= (boost::uint8_t(d24) & 0x1) << 7;
            reg |= (boost::uint8_t(cps) & 0x1) << 6;
            reg |= (boost::uint8_t(icp) & 0x1) << 5;
            break;
        case 7:
            reg |= (boost::uint8_t(vco) & 0x1f) << 3;
            reg |= (boost::uint8_t(vas) & 0x1) << 2;
            reg |= (boost::uint8_t(adl) & 0x1) << 1;
            reg |= (boost::uint8_t(ade) & 0x1) << 0;
            break;
        case 8:
            reg |= (boost::uint8_t(lp) & 0xff) << 0;
            break;
        case 9:
            reg |= (boost::uint8_t(stby) & 0x1) << 7;
            reg |= (boost::uint8_t(pwdn) & 0x1) << 5;
            reg |= (boost::uint8_t(bbg) & 0xf) << 0;
            break;
        case 10:
            reg |= (boost::uint8_t(pll_shutdown) & 0x1) << 6;
            reg |= (boost::uint8_t(div_shutdown) & 0x1) << 5;
            reg |= (boost::uint8_t(vco_shutdown) & 0x1) << 4;
            reg |= (boost::uint8_t(bb_shutdown) & 0x1) << 3;
            reg |= (boost::uint8_t(rfmix_shutdown) & 0x1) << 2;
            reg |= (boost::uint8_t(rfvga_shutdown) & 0x1) << 1;
            reg |= (boost::uint8_t(fe_shutdown) & 0x1) << 0;
            break;
        case 11:
            reg |= (boost::uint8_t(cptst) & 0x7) << 5;
            reg |= (boost::uint8_t(turbo) & 0x1) << 3;
            reg |= (boost::uint8_t(ld_mux) & 0x7) << 0;
            break;
        }
    ...
    void set_reg(boost::uint8_t addr, boost::uint8_t reg){
        ...
        case 0:
            ...
            n_divider_msb = boost::uint8_t((reg >> 0) & 0x7f);
            break;
        case 1:
            n_divider_lsb = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 2:
            cpmp = boost::uint8_t((reg >> 6) & 0x3);
            cplin = boost::uint8_t((reg >> 4) & 0x3);
            f_divider_mmsb = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 3:
            f_divider_msb = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 4:
            f_divider_lsb = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 5:
            xtal_divider = xtal_divider_t((reg >> 5) & 0x7);
            r_divider = boost::uint8_t((reg >> 0) & 0x1f);
            break;
        case 6:
            d24 = d24_t((reg >> 7) & 0x1);
            cps = cps_t((reg >> 6) & 0x1);
            ...
            break;
        case 7:
            vco = boost::uint8_t((reg >> 3) & 0x1f);
            vas = vas_t((reg >> 2) & 0x1);
            adl = adl_t((reg >> 1) & 0x1);
            ade = ade_t((reg >> 0) & 0x1);
            break;
        case 8:
            lp = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 9:
            stby = stby_t((reg >> 7) & 0x1);
            pwdn = pwdn_t((reg >> 5) & 0x1);
            bbg = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 10:
            ...
            break;
        case 11:
            cptst = boost::uint8_t((reg >> 5) & 0x7);
            turbo = boost::uint8_t((reg >> 3) & 0x1);
    ...
    boost::uint16_t get_n_divider(void){
        return
        (boost::uint16_t(n_divider_lsb & 0xff) << 0) |
        (boost::uint16_t(n_divider_msb & 0x7f) << 8) |
        0;
    }

    void set_n_divider(boost::uint16_t reg){
        n_divider_lsb = (reg >> 0) & 0xff;
        n_divider_msb = (reg >> 8) & 0x7f;
    }

    boost::uint32_t get_f_divider(void){
        return
        (boost::uint32_t(f_divider_lsb & 0xff) << 0) |
        (boost::uint32_t(f_divider_msb & 0xff) << 8) |
        (boost::uint32_t(f_divider_mmsb & 0xf) << 16) |
        0;
    }

    void set_f_divider(boost::uint32_t reg){
...
public:
    ...
    boost::uint8_t get_reg(boost::uint8_t addr){
        ...
        switch(addr){
        case 12:
            reg |= (boost::uint8_t(por) & 0x1) << 7;
            reg |= (boost::uint8_t(vasa) & 0x1) << 6;
            reg |= (boost::uint8_t(vase) & 0x1) << 5;
            reg |= (boost::uint8_t(ld) & 0x1) << 4;
            break;
        case 13:
            reg |= (boost::uint8_t(vcosbr) & 0x1f) << 3;
            reg |= (boost::uint8_t(adc) & 0x7) << 0;
            break;
        }
        return boost::uint8_t(reg);
    }
    ...
    void set_reg(boost::uint8_t addr, boost::uint8_t reg){
        ...
        case 12:
            ...
            break;
        case 13:
            vcosbr = boost::uint8_t((reg >> 3) & 0x1f);
            adc = adc_t((reg >> 0) & 0x7);
            break;
        }
    }
