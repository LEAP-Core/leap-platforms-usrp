/***********************************************************************
 * This file was generated by /home/kfleming/uhd/host/lib/ic_reg_maps/gen_ad9510_regs.py on Sat Apr  2 14:36:28 2011
 **********************************************************************/
...
public:
    ...
    boost::uint8_t acounter;
    boost::uint8_t bcounter_msb;
    boost::uint8_t bcounter_lsb;
    enum lor_enable_t{
        LOR_ENABLE_ENB = 0,
        LOR_ENABLE_DIS = 1
    };
    ...
    boost::uint8_t ncounter_reset;
    boost::uint8_t rcounter_reset;
    ...
    boost::uint8_t b_counter_bypass;
    boost::uint8_t ref_counter_msb;
    boost::uint8_t ref_counter_lsb;
    ...
    boost::uint8_t delay_control_out5;
    ...
    boost::uint8_t delay_fine_adjust_out5;
    boost::uint8_t delay_control_out6;
    ...
    boost::uint8_t delay_fine_adjust_out6;
    ...
    boost::uint8_t power_down_lvds_cmos_out4;
    ...
    boost::uint8_t power_down_lvds_cmos_out5;
    ...
    boost::uint8_t power_down_lvds_cmos_out6;
    ...
    boost::uint8_t power_down_lvds_cmos_out7;
    ...
    boost::uint8_t clk1_power_down;
    boost::uint8_t clk2_power_down;
    boost::uint8_t prescaler_clock_pd;
    boost::uint8_t refin_power_down;
    boost::uint8_t all_clock_inputs_pd;
    boost::uint8_t divider_high_cycles_out0;
    boost::uint8_t divider_low_cycles_out0;
    boost::uint8_t phase_offset_out0;
    boost::uint8_t start_out0;
    boost::uint8_t force_out0;
    boost::uint8_t nosync_out0;
    boost::uint8_t bypass_divider_out0;
    boost::uint8_t divider_high_cycles_out1;
    boost::uint8_t divider_low_cycles_out1;
    boost::uint8_t phase_offset_out1;
    boost::uint8_t start_out1;
    boost::uint8_t force_out1;
    boost::uint8_t nosync_out1;
    boost::uint8_t bypass_divider_out1;
    boost::uint8_t divider_high_cycles_out2;
    boost::uint8_t divider_low_cycles_out2;
    boost::uint8_t phase_offset_out2;
    boost::uint8_t start_out2;
    boost::uint8_t force_out2;
    boost::uint8_t nosync_out2;
    boost::uint8_t bypass_divider_out2;
    boost::uint8_t divider_high_cycles_out3;
    boost::uint8_t divider_low_cycles_out3;
    boost::uint8_t phase_offset_out3;
    boost::uint8_t start_out3;
    boost::uint8_t force_out3;
    boost::uint8_t nosync_out3;
    boost::uint8_t bypass_divider_out3;
    boost::uint8_t divider_high_cycles_out4;
    boost::uint8_t divider_low_cycles_out4;
    boost::uint8_t phase_offset_out4;
    boost::uint8_t start_out4;
    boost::uint8_t force_out4;
    boost::uint8_t nosync_out4;
    boost::uint8_t bypass_divider_out4;
    boost::uint8_t divider_high_cycles_out5;
    boost::uint8_t divider_low_cycles_out5;
    boost::uint8_t phase_offset_out5;
    boost::uint8_t start_out5;
    boost::uint8_t force_out5;
    boost::uint8_t nosync_out5;
    boost::uint8_t bypass_divider_out5;
    boost::uint8_t divider_high_cycles_out6;
    boost::uint8_t divider_low_cycles_out6;
    boost::uint8_t phase_offset_out6;
    boost::uint8_t start_out6;
    boost::uint8_t force_out6;
    boost::uint8_t nosync_out6;
    boost::uint8_t bypass_divider_out6;
    boost::uint8_t divider_high_cycles_out7;
    boost::uint8_t divider_low_cycles_out7;
    boost::uint8_t phase_offset_out7;
    boost::uint8_t start_out7;
    boost::uint8_t force_out7;
    boost::uint8_t nosync_out7;
    boost::uint8_t bypass_divider_out7;
    ...
    boost::uint8_t dist_power_down;
    boost::uint8_t sync_power_down;
    ...
    boost::uint8_t update_registers;
    ...
    boost::uint8_t get_reg(boost::uint16_t addr){
        ...
        switch(addr){
        case 0:
            reg |= (boost::uint32_t(long_instruction) & 0x1) << 4;
            reg |= (boost::uint32_t(soft_reset) & 0x1) << 5;
            reg |= (boost::uint32_t(lsb_first) & 0x1) << 6;
            reg |= (boost::uint32_t(sdo_inactive) & 0x1) << 7;
            break;
        case 4:
            reg |= (boost::uint32_t(acounter) & 0x3f) << 0;
            break;
        case 5:
            reg |= (boost::uint32_t(bcounter_msb) & 0x1f) << 0;
            break;
        case 6:
            reg |= (boost::uint32_t(bcounter_lsb) & 0xff) << 0;
            break;
        case 7:
            reg |= (boost::uint32_t(lor_enable) & 0x1) << 2;
            reg |= (boost::uint32_t(lor_ildd) & 0x3) << 5;
            break;
        case 8:
            reg |= (boost::uint32_t(charge_pump_mode) & 0x3) << 0;
            reg |= (boost::uint32_t(pll_mux_control) & 0xf) << 2;
            reg |= (boost::uint32_t(pfd_polarity) & 0x1) << 6;
            break;
        case 9:
            reg |= (boost::uint32_t(reset_all_counters) & 0x1) << 0;
            reg |= (boost::uint32_t(ncounter_reset) & 0x1) << 1;
            reg |= (boost::uint32_t(rcounter_reset) & 0x1) << 2;
            reg |= (boost::uint32_t(cp_current_setting) & 0x7) << 4;
            break;
        case 10:
            reg |= (boost::uint32_t(pll_power_down) & 0x3) << 0;
            reg |= (boost::uint32_t(prescaler_value) & 0x7) << 2;
            reg |= (boost::uint32_t(b_counter_bypass) & 0x1) << 6;
            break;
        case 11:
            reg |= (boost::uint32_t(ref_counter_msb) & 0x3f) << 0;
            break;
        case 12:
            reg |= (boost::uint32_t(ref_counter_lsb) & 0xff) << 0;
            break;
        case 13:
            reg |= (boost::uint32_t(antibacklash_pw) & 0x3) << 0;
            reg |= (boost::uint32_t(dld_window) & 0x1) << 5;
            reg |= (boost::uint32_t(lock_detect_disable) & 0x1) << 6;
            break;
        case 45:
            reg |= (boost::uint32_t(clock_select) & 0x1) << 0;
            reg |= (boost::uint32_t(clk1_power_down) & 0x1) << 1;
            reg |= (boost::uint32_t(clk2_power_down) & 0x1) << 2;
            reg |= (boost::uint32_t(prescaler_clock_pd) & 0x1) << 3;
            reg |= (boost::uint32_t(refin_power_down) & 0x1) << 4;
            reg |= (boost::uint32_t(all_clock_inputs_pd) & 0x1) << 5;
            break;
        case 52:
            reg |= (boost::uint32_t(delay_control_out5) & 0x1) << 0;
            break;
        case 53:
            reg |= (boost::uint32_t(ramp_current_out5) & 0x7) << 0;
            reg |= (boost::uint32_t(ramp_capacitor_out5) & 0x7) << 3;
            break;
        case 54:
            reg |= (boost::uint32_t(delay_fine_adjust_out5) & 0x1f) << 1;
            break;
        case 56:
            reg |= (boost::uint32_t(delay_control_out6) & 0x1) << 0;
            break;
        case 57:
            reg |= (boost::uint32_t(ramp_current_out6) & 0x7) << 0;
            reg |= (boost::uint32_t(ramp_capacitor_out6) & 0x7) << 3;
            break;
        case 58:
            reg |= (boost::uint32_t(delay_fine_adjust_out6) & 0x1f) << 1;
            reg |= (boost::uint32_t(sync_detect_enable) & 0x1) << 0;
            reg |= (boost::uint32_t(sync_select) & 0x1) << 1;
            reg |= (boost::uint32_t(soft_sync) & 0x1) << 2;
            reg |= (boost::uint32_t(dist_power_down) & 0x1) << 3;
            reg |= (boost::uint32_t(sync_power_down) & 0x1) << 4;
            reg |= (boost::uint32_t(function_pin_select) & 0x3) << 5;
            break;
        case 60:
            reg |= (boost::uint32_t(power_down_lvpecl_out0) & 0x3) << 0;
            reg |= (boost::uint32_t(output_level_lvpecl_out0) & 0x3) << 2;
            break;
        case 61:
            reg |= (boost::uint32_t(power_down_lvpecl_out1) & 0x3) << 0;
            reg |= (boost::uint32_t(output_level_lvpecl_out1) & 0x3) << 2;
            break;
        case 62:
            reg |= (boost::uint32_t(power_down_lvpecl_out2) & 0x3) << 0;
            reg |= (boost::uint32_t(output_level_lvpecl_out2) & 0x3) << 2;
            break;
        case 63:
            reg |= (boost::uint32_t(power_down_lvpecl_out3) & 0x3) << 0;
            reg |= (boost::uint32_t(output_level_lvpecl_out3) & 0x3) << 2;
            break;
        case 64:
            reg |= (boost::uint32_t(power_down_lvds_cmos_out4) & 0x1) << 0;
            reg |= (boost::uint32_t(output_level_lvds_out4) & 0x3) << 1;
            reg |= (boost::uint32_t(lvds_cmos_select_out4) & 0x1) << 3;
            reg |= (boost::uint32_t(inverted_cmos_driver_out4) & 0x1) << 4;
            break;
        case 65:
            reg |= (boost::uint32_t(power_down_lvds_cmos_out5) & 0x1) << 0;
            reg |= (boost::uint32_t(output_level_lvds_out5) & 0x3) << 1;
            reg |= (boost::uint32_t(lvds_cmos_select_out5) & 0x1) << 3;
            reg |= (boost::uint32_t(inverted_cmos_driver_out5) & 0x1) << 4;
            break;
        case 66:
            reg |= (boost::uint32_t(power_down_lvds_cmos_out6) & 0x1) << 0;
            reg |= (boost::uint32_t(output_level_lvds_out6) & 0x3) << 1;
            reg |= (boost::uint32_t(lvds_cmos_select_out6) & 0x1) << 3;
            reg |= (boost::uint32_t(inverted_cmos_driver_out6) & 0x1) << 4;
            break;
        case 67:
            reg |= (boost::uint32_t(power_down_lvds_cmos_out7) & 0x1) << 0;
            reg |= (boost::uint32_t(output_level_lvds_out7) & 0x3) << 1;
            reg |= (boost::uint32_t(lvds_cmos_select_out7) & 0x1) << 3;
            reg |= (boost::uint32_t(inverted_cmos_driver_out7) & 0x1) << 4;
            break;
        case 72:
            reg |= (boost::uint32_t(divider_high_cycles_out0) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out0) & 0xf) << 4;
            break;
        case 73:
            reg |= (boost::uint32_t(phase_offset_out0) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out0) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out0) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out0) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out0) & 0x1) << 7;
            break;
        case 74:
            reg |= (boost::uint32_t(divider_high_cycles_out1) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out1) & 0xf) << 4;
            break;
        case 75:
            reg |= (boost::uint32_t(phase_offset_out1) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out1) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out1) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out1) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out1) & 0x1) << 7;
            break;
        case 76:
            reg |= (boost::uint32_t(divider_high_cycles_out2) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out2) & 0xf) << 4;
            break;
        case 77:
            reg |= (boost::uint32_t(phase_offset_out2) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out2) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out2) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out2) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out2) & 0x1) << 7;
            break;
        case 78:
            reg |= (boost::uint32_t(divider_high_cycles_out3) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out3) & 0xf) << 4;
            break;
        case 79:
            reg |= (boost::uint32_t(phase_offset_out3) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out3) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out3) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out3) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out3) & 0x1) << 7;
            break;
        case 80:
            reg |= (boost::uint32_t(divider_high_cycles_out4) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out4) & 0xf) << 4;
            break;
        case 81:
            reg |= (boost::uint32_t(phase_offset_out4) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out4) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out4) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out4) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out4) & 0x1) << 7;
            break;
        case 82:
            reg |= (boost::uint32_t(divider_high_cycles_out5) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out5) & 0xf) << 4;
            break;
        case 83:
            reg |= (boost::uint32_t(phase_offset_out5) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out5) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out5) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out5) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out5) & 0x1) << 7;
            break;
        case 84:
            reg |= (boost::uint32_t(divider_high_cycles_out6) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out6) & 0xf) << 4;
            break;
        case 85:
            reg |= (boost::uint32_t(phase_offset_out6) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out6) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out6) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out6) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out6) & 0x1) << 7;
            break;
        case 86:
            reg |= (boost::uint32_t(divider_high_cycles_out7) & 0xf) << 0;
            reg |= (boost::uint32_t(divider_low_cycles_out7) & 0xf) << 4;
            break;
        case 87:
            reg |= (boost::uint32_t(phase_offset_out7) & 0xf) << 0;
            reg |= (boost::uint32_t(start_out7) & 0x1) << 4;
            reg |= (boost::uint32_t(force_out7) & 0x1) << 5;
            reg |= (boost::uint32_t(nosync_out7) & 0x1) << 6;
            reg |= (boost::uint32_t(bypass_divider_out7) & 0x1) << 7;
            break;
        case 90:
            reg |= (boost::uint32_t(update_registers) & 0x1) << 0;
            break;
        }
        return reg;
    }
